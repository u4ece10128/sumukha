...
from sumukha.encoding.build_encoders import general_encoders
...
def run_encode(root_path='./', preprocess_path=config.input_preprocess_path,
    ...
    # domain_specific_encoders(preprocess_path=root_path + preprocess_path, model_result_path=root_path + model_result_path)
